...
3. `docs/architecture-docs-for-agent/ARCHITECTURE.md` 明确全栈演进层次
4. `docs/architecture-docs-for-agent/first-layer/SDK.md` 与 `docs/architecture-docs-for-agent/first-layer/CHANNELS.md` 明确新增边界
