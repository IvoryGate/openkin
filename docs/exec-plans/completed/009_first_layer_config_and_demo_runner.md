...
- **文档**：[`docs/architecture-docs-for-agent/first-layer/DEMO_FIRST_LAYER.md`](../../architecture-docs-for-agent/first-layer/DEMO_FIRST_LAYER.md)，`README.md` / `docs/index.md` 已指向。
