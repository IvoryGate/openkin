...
const requiredPaths = [
  ...
  'docs/architecture-docs-for-agent/first-layer/DEMO_FIRST_LAYER.md',
  'docs/architecture-docs-for-agent/first-layer/FIRST_LAYER_COVERAGE.md',
  'docs/architecture-docs-for-agent/second-layer/DEMO_SECOND_LAYER.md',
  'docs/architecture-docs-for-agent/second-layer/SECOND_LAYER_COVERAGE.md',
