...
const requiredPaths = [
  ...
  'docs/architecture/first-layer/DEMO_FIRST_LAYER.md',
  'docs/architecture/first-layer/FIRST_LAYER_COVERAGE.md',
  'docs/architecture/second-layer/DEMO_SECOND_LAYER.md',
  'docs/architecture/second-layer/SECOND_LAYER_COVERAGE.md',
